 ...
 * 1st method()					DO NOT OVERRIDE!
 * 3rd before<method>()			override to do something before the method call
 * 4th _<method>()				override to modify default database actions
...
abstract class AbstractController {
	...
	/*
	 * This method will be called, if a non-existing method is being called e.g.: $controller->post();
	...
	public function modifyResultGet() {
		$this->result = \Database::resultToArray($this->result, false);
	}

	public function modifyResultPost() {
		$this->result = \Database::resultToArray($this->result);
	}
